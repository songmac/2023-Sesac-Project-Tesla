...
# LDA 데이터를 csv 파일 저장
def save_topics_csv(lda, num_topics, save_result_to: str = './yumi/data/merge/lda_by_topics.csv'):
...
#   len(top_words) / (lda.num_topics * topn)
  ...
  pyLDAvis.save_html(vis, './yumi/data/lda_visualization.html')
