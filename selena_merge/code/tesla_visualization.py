...
import pandas as pd
import matplotlib.pyplot as plt
import selena_merge.module.csvfile as csvfile

# ldaFilePath = './yumi/data/merge/'
...
plt.xticks(rotation=45)
plt.tight_layout() 
plt.savefig("./yumi/data/img/total_stock_daily_graph2.png", format="png")
#plt.show()
...
plt.tight_layout()
#그래프 출력
plt.savefig("./yumi/data/img/total_stock_news_graph.png", format="png")
plt.show()
...
plt.tight_layout()
#그래프 출력
plt.savefig("./yumi/data/img/total_stock_news_graph2.png", format="png")
plt.show()